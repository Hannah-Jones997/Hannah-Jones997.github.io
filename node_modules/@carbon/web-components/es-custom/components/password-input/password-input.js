...
import { INPUT_TYPE, INPUT_TOOLTIP_ALIGNMENT, INPUT_TOOLTIP_DIRECTION } from './defs.js';
export { INPUT_SIZE } from './defs.js';
 ...
 */
let CDSPasswordInput = class CDSPasswordInput extends CDSTextInput {
    constructor() {
        super(...arguments);
        /**
      ...
      <label class="${labelClasses}"> ${label} </label>
        ...
        const helper = helperText
          ...
          <slot name="helper-text"> ${helperText} </slot>
            ...
            : null;
        let align = '';
        if (this.tooltipDirection === INPUT_TOOLTIP_DIRECTION.TOP ||
            this.tooltipDirection === INPUT_TOOLTIP_DIRECTION.BOTTOM) {
...
CDSPasswordInput.shadowRootOptions = Object.assign(Object.assign({}, LitElement.shadowRootOptions), { delegatesFocus: true });
