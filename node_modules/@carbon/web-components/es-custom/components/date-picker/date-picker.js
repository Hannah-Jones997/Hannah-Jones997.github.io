...
let CDSDatePicker = class CDSDatePicker extends HostListenerMixin(FormMixin(LitElement)) {
    constructor() {
        super(...arguments);
        /**
         * The slotted `<cds-custom-date-input kind="from">`.
         */
    ...
    get _datePickerPlugins() {
        ...
        if (mode === DATE_PICKER_MODE.RANGE) {
            ...
            // We want to ensure our handler of `onValueUpdate` (notably one in `<cds-custom-date-picker-input>`)
    ...
    get _datePickerOptions() {
        ...
        // We use `<cds-custom-date-picker-input>` to communicate values/events with Flatpickr,
