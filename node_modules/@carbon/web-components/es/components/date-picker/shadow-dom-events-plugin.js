 ...
 */
const adjustDate = (localDate, { date: moveDate = 0 }) => {
...
var shadowDOMEventPlugin = () => (fp) => {
    const getDateElem = (localDate) => find(fp.daysContainer.firstElementChild.children, ({ dateObj }) => localDate.getTime() === dateObj.getTime());
    /**
...
export { shadowDOMEventPlugin as default };
