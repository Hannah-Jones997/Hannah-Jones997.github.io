...
import{__decorate as e}from"../../node_modules/tslib/tslib.es6.min.js";import"../../node_modules/@lit/reactive-element/reactive-element.min.js";import{html as t}from"../../node_modules/lit-html/lit-html.min.js";import{LitElement as s}from"../../node_modules/lit-element/lit-element.min.js";import{property as o}from"../../node_modules/@lit/reactive-element/decorators/property.min.js";import{prefix as l}from"../../globals/settings.min.js";import i from"./number-input.scss.min.js";import{carbonElement as m}from"../../globals/decorators/carbon-element.min.js";let r=class extends s{constructor(){super(...arguments),this.hideLabel=!1}render(){const{hideLabel:e}=this;return t`
      ${!e&&t` <span class="${l}--label ${l}--skeleton"></span> `}
      <div class="${l}--number ${l}--skeleton"></div>
    `}};r.styles=i,e([o({type:Boolean,reflect:!0,attribute:"hide-label"})],r.prototype,"hideLabel",void 0),r=e([m(`${l}-number-input-skeleton`)],r);
