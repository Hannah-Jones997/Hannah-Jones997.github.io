 ...
 */let p=class extends(a(r(o))){constructor(){super(...arguments),this.triggerEvents=t=>{if(this.disabled)t.stopPropagation();else{const e={bubbles:!0,cancelable:!0,composed:!0,detail:{triggeredBy:t.target}};this.dispatchEvent(new CustomEvent(this.constructor.eventBeforeSelected,e))&&(this.selected=!this.selected,this.dispatchEvent(new CustomEvent(this.constructor.eventSelected,e)))}},this._handleClick=t=>{this.triggerEvents(t)},this._handleKeyDown=t=>{"Enter"!==t.key&&" "!==t.key||this.triggerEvents(t)},this.disabled=!1,this.selected=!1,this.size=d.MEDIUM,this.text="",this._hasEllipsisApplied=!1}async updated(){var t,e,o;await this.updateComplete;const s=null===(o=null===(e=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector(`${l}-tag`))||void 0===e?void 0:e.shadowRoot)||void 0===o?void 0:o.querySelector(`.${l}--tag__label`);if(!s)return;const i=s.scrollWidth>s.clientWidth;this._hasEllipsisApplied=i}render(){const{disabled:t,selected:o,size:s,text:i,_hasEllipsisApplied:l}=this;return e` ${l?e` <cds-tooltip align="bottom" keyboard-only leave-delay-ms=${0}>
        ...
        `}`}static get eventBeforeSelected(){return`${l}-selectable-tag-beingselected`}static get eventSelected(){return`${l}-selectable-tag-selected`}};p.styles=m,t([n("shadowRoot:click")],p.prototype,"_handleClick",void 0),t([n("shadowRoot:keydown")],p.prototype,"_handleKeyDown",void 0),t([s({type:Boolean,reflect:!0})],p.prototype,"disabled",void 0),t([s({type:Boolean,reflect:!0})],p.prototype,"selected",void 0),t([s({type:String,reflect:!0})],p.prototype,"size",void 0),t([s({type:String,reflect:!0})],p.prototype,"text",void 0),t([i()],p.prototype,"_hasEllipsisApplied",void 0),p=t([c(`${l}-selectable-tag`)],p);export{d as TAG_SIZE};
